...
class TopBannerViewController: UIViewController
{
    ...
    private func displayLoadAlert() {
        let loadAlert = UIAlertController(title: "Alert", message: "Loading Top Banner", preferredStyle: .alert)
    ...
    private func displayShowAlert() {
        let showAlert = UIAlertController(title: "Alert", message: "Showing Top Banner", preferredStyle: .alert)
        let okAction = UIAlertAction(title: "OK", style: .default) { (_) in
    ...
    private func displayHideAlert() {
        let hideAlert = UIAlertController(title: "Alert", message: "Hiding Top Banner", preferredStyle: .alert)
        let okAction = UIAlertAction(title: "OK", style: .default) { (_) in
            Appodeal.hideBanner()
        }
